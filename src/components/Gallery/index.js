...
class Gallery extends Component {
  ...
  return (
    ...
    <div id="test">
      ...
      <a className="mobil-galdiv-atag"href="str8jacket/#/photography"><div className="mobile-photo-gal-div">
      ...
      <a className="galdiv-atag"href="str8jacket/#/videography"><div className="mobile-video-div">
      ...
      <div className="galdiv">
        <a className="galdiv-atag"href="str8jacket/#/photography"><div className="photo-gal-div">
          <p className="pic-gal-div">PHOTOGRAPHY</p>
        </div></a>
        <a className="galdiv-atag"href="str8jacket/#/videography"><div className="video-div">
